...
$GLOBALS['TL_LANG']['tl_module']['cowegis_client'][0]        = 'Cowegis Javascript Client';
$GLOBALS['TL_LANG']['tl_module']['cowegis_client'][1]        = 'Please choose how to integrate the javascript client.';
$GLOBALS['TL_LANG']['tl_module']['cowegis_client_custom'][0] = 'Cowegis custom client';
$GLOBALS['TL_LANG']['tl_module']['cowegis_client_custom'][1] = 'Choose a custom client.';
