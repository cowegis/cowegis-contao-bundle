...
//            ['netzmacht.contao_leaflet.listeners.dca.leaflet', 'clearCache'],
    ...
    'list' => [
        ...
        'global_operations' => [
            'styles' => [
                'label'      => &$GLOBALS['TL_LANG']['tl_cowegis_popup']['styles'],
                'href'       => 'table=tl_cowegis_style',
                'icon'       => 'bundles/cowegiscontao/img/style.png',
                'attributes' => 'onclick="Backend.getScrollOffset();"',
            ],
            'icons'  => [
                'label'      => &$GLOBALS['TL_LANG']['tl_cowegis_popup']['icons'],
        ...
        'operations'        => [
            'edit'   => [
                'label' => &$GLOBALS['TL_LANG']['tl_cowegis_popup']['edit'],
                'href'  => 'act=edit',
                'icon'  => 'edit.gif',
            ],
            'copy'   => [
                'label' => &$GLOBALS['TL_LANG']['tl_cowegis_popup']['copy'],
                'href'  => 'act=copy',
                'icon'  => 'copy.gif',
            ],
            'delete' => [
                'label'      => &$GLOBALS['TL_LANG']['tl_cowegis_popup']['delete'],
                'href'       => 'act=delete',
                'icon'       => 'delete.gif',
            ...
            'toggle' => [
                'label'           => &$GLOBALS['TL_LANG']['tl_cowegis_popup']['toggle'],
                'icon'            => 'visible.gif',
            ...
            'show'   => [
                'label' => &$GLOBALS['TL_LANG']['tl_cowegis_popup']['show'],
                'href'  => 'act=show',
                'icon'  => 'show.gif',
            ],
        ],
